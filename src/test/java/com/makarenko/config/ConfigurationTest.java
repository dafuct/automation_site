...
import com.makarenko.listener.EventListener;
import java.io.File;
...
public class ConfigurationTest {
  ...
  private static final Logger LOG = LogManager.getLogger(ConfigurationTest.class);
  ...
  private WebDriver getDriver() {
    System.setProperty("webdriver.gecko.driver",
        new File(ConfigurationTest.class.getResource("/geckodriver.exe").getFile()).getPath());
